...
Хостов: 37/3 = 13
Репликация master-slave, sync, RF = 13
Шардирование: да. По одному шарду на хост. Распределение данных между шардами с помощью hash по id
...
Шардирование используется, так как имеется большое кол-во данных на больгом кол-ве хостов. Кол-во шардов == кол-во хостов
...
Партиций: 2 (активные юзеры [постов > 25] и пассивные юзеры)
Шардирование: да. Шардов будет 3 (по одному на хост). Распределяться по hash от id
